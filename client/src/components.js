// REsponsavel por construir o layout sob demanda
...
export default class ComponentsBuilder {
    ...
    //Retorna as propriedades para se construir um component
    // # e para colocar como privado.
    #baseComponent() {
        return {
            border: 'line',
            mouse: true,
    ...
    setScreen({ title }) {
        this.#screen = blessed.screen({
            // Redimensionamento na tela automatico.
            smartCSR: true,
            title
        })
